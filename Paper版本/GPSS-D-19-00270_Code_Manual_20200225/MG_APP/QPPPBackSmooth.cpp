...
//Back smooth Multiple epoch cycles
        for (int epoch_num = all_epoch_len; epoch_num > 0;epoch_num--)
        {
            QVector< SatlitData > epochSatlitData;//Temporary storage of uncalculated data for each epoch satellite
            epochSatlitData = multepochSatlitData.at(epoch_num-1);
            ...
            double temp_spp_pos[3] = {last_allReciverPos.at(epoch_num-1).spp_pos[0],
                                      last_allReciverPos.at(epoch_num-1).spp_pos[1],
                                      last_allReciverPos.at(epoch_num-1).spp_pos[2]};
            //Monitor satellite quality and cycle slip
                                      ...
                                      int epochNum, MatrixXd *P)
{
    ...
    epochRecivePos.epochNum = epochNum;
